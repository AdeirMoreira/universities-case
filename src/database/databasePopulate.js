...
exports.countrys = exports.universityModel = void 0;
...
exports.universityModel = mongoose_1["default"].model('Universitie', UniversitySchema);
exports.countrys = [
    'Argentina',
    'Brazil',
    'Chile',
...
function create() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            promisesArray = exports.countrys.map(function (country) {
                return getUniversitiesbyCountryName(country);
            });
            return [2 /*return*/, Promise.all(promisesArray)];
        });
    });
}
function getUniversitiesbyCountryName(country) {
    return __awaiter(this, void 0, void 0, function () {
        var universities;
        return __generator(this, function (_a) {
            switch (_a.label) {
